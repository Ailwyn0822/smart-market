  ...
  <div class="page-container">
    <div class="page-header">
      ...
      <div class="header-actions">
        <el-input v-model="searchQuery" placeholder="搜尋商品名稱..." clearable style="width: 240px; margin-right: 12px;"
          @input="onSearch" />
      ...
      <el-table :data="products" v-loading="loading" stripe style="width: 100%">
        ...
        <el-table-column label="圖片" width="70">
          <template #default="{ row }">
            <el-image :src="row.imageUrl" fit="cover" style="width: 44px; height: 44px; border-radius: 4px;" />
          </template>
        </el-table-column>
        ...
        <el-table-column label="狀態" width="80">
          <template #default="{ row }">
            <el-switch v-model="row.isActive" @change="toggleStatus(row)" />
          </template>
        </el-table-column>
...
const products = shallowRef<ApiProduct[]>([])
