                        ...
                        <div class="pt-1">
                            <div class="flex justify-between items-center text-[10px] font-bold text-gray-400 mb-1">
                                ...
                                <button v-if="order.status === 'out_for_delivery'"
                                    ...
                                    class="bg-accent-blue text-white px-2 py-1 rounded bg-opacity-90 hover:bg-opacity-100 text-[12px]">??????</button>
            ...
            <div v-if="showReviewModal"
                ...
                <div
                    ...
                    <textarea v-model="reviewForm.comment" rows="4"
                        class="w-full bg-cream rounded-xl border-2 border-content p-4 font-bold text-sm focus:outline-none focus:bg-white transition-colors resize-none placeholder-gray-400 mb-6"
